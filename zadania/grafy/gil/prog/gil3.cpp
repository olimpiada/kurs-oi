/*
 * Weryfikuj±ce rozwi±zanie wzorcowe do zadania Gildie/mpil005
 * Autor: Juliusz Sompolski
 * Data: 17.09.2009
 * Zach³annie przydziela nieodwiedzonemu s±siadami jedn± gildiê,
 * a wszystkim jego s±siadom gildiê przeciwn±.
 */
#include <cstdio>
#include <vector>
using namespace std;
